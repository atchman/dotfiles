...
complete -c borgmatic -f -n "$exact_option_condition" -a '-c --config' -d 'Configuration filename or directory, can specify flag multiple times, defaults to: -c /etc/borgmatic/config.yaml -c /etc/borgmatic.d -c /home/atchman/.config/borgmatic/config.yaml -c /home/atchman/.config/borgmatic.d'
...
complete -c borgmatic -f -n "$exact_option_condition" -a '--make-parent-dirs' -d 'Create any missing parent directories of the repository directory' -n "__fish_seen_subcommand_from repo-create"
