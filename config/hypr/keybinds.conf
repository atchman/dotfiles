...
bind = $mainMod, L, togglespecialworkspace, localsend
bind = $mainMod, H, togglespecialworkspace, sound
...
bind = $mainMod SHIFT, E, togglespecialworkspace
